<?php
	...
	foreach ($Hardware as $i) {
		echo "<tr><td><a href=\"installation.php?identification_code=". $i['Identificatiecode']. "\">". $i['Identificatiecode']. "</a></td><td>". $i['SoortHardware']. "</td><td>". $i['Locatie']. "</td><td>". $i['MerkNaam']. "</td></td><td>". $i['LeverancierNaam']. "</td></td><td>". $i['JaarVanAanschaf']. "</td></td></tr>";
	}
	echo "</table>";
?>